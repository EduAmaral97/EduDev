...
--	AND A.B1_COD = 'LB012F'   
--	AND A.B1_COD = 'EP199I'   
GROUP BY  A.B1_COD,A.B1_ZIDWEB, A.B1_GRUPO,  A.B1_DESC, A.B1_ZDESRDZ, B5_ALTURA, B5_COMPR, B5_LARG, CONVERT(VARBINARY(8000),A.B1_ZTITWEB),A.B1_ZAPRES1,A.B1_UM,D.ZB2_DESFAM,A.B1_UCOM,A.B1_GRTRIB,A.B1_ZPROMOC,A.B1_ZPERDES,A.B1_ZPROWEB,A.B1_ZPDEWEB,A.B1_ZUPSITE,A.B1_PROC,A.B1_LOJPROC,E.A2_NOME,A.B1_CUSTD,A.B1_ZPERCAT,A.B1_ZCODFAM,SUBSTRING(A.B1_GRUPO,1,2),A.B1_MSBLQL,A.B1_ZMIXFL1
ORDER BY 1
