//////////////////////////////////////////////////////////////////////////////
//                                                                          //   
//             Pedido de Compra Fora da Data de Entregue                    //
//                                                                          // 
//  2- Prazo de Entrega ao Cliente Maior que a Data do Pedido de Compra     //
//                                                                          //   
//////////////////////////////////////////////////////////////////////////////

SELECT 	A.C7_FILIAL,A.C7_NUM,A.C7_ITEM,A.C7_PRODUTO,I.B1_DESC,G.A1_COD, G.A1_NOME  , A.C7_LOCAL,
		-- Saldo Produto  --
		...
		ISNULL((SELECT  SUM(B2_RESERVA)  FROM SB2010 WHERE D_E_L_E_T_ = '' AND  B2_LOCAL IN ('01') AND B2_COD = A.C7_PRODUTO),0) AS QTDRES,
		...
		A.C7_UM,A.C7_QUANT,C7_QUJE,C7_QTDSOL,A.C7_CC,CONVERT(VARCHAR,CAST(A.C7_EMISSAO AS DATETIME),103) AS EMIPC,
       	B.C1_SOLICIT,D.L1_CLIENTE,D.L1_LOJA,G.A1_NREDUZ,D.L1_VEND,H.A3_NREDUZ,B.C1_FILENT,D.L1_NUMATEN,B.C1_ORCAM,B.C1_PEDRES,
       	A.C7_NUMSC,CONVERT(VARCHAR,CAST(F.UA_ZDTAENT AS DATETIME),103) AS DATATM,CONVERT(VARCHAR,CAST(A.C7_DATPRF AS DATETIME),103) AS DATFOR,
       	DIFDIAS=(CASE WHEN A.C7_DATPRF = '' OR F.UA_ZDTAENT = '' THEN 0 ELSE DATEDIFF(DAY,A.C7_DATPRF,F.UA_ZDTAENT) END)
FROM SC7010 AS A
