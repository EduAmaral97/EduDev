...
CREATE PROCEDURE CUBOFAT AS


/*------------------------------DROP DA TABELA------------------------------------*/ 


DROP TABLE Z1CUBOFAT


/*------------------------------CREATE TABLE------------------------------------*/ 

CREATE TABLE Z1CUBOFAT
    (
	Z1_NUM_ATM			VARCHAR(6),
	Z1_FILIAL_ATM		VARCHAR(4),
	Z1_DT_EMI_ATM		VARCHAR(30),
	Z1_CODPROD			VARCHAR(15),
	Z1_PROD_TROCADO		VARCHAR(15),
	Z1_PRODUTO			VARCHAR(70),
	Z1_PROD_DESC_REDU	VARCHAR(40),
	Z1_COD_APRE			VARCHAR(18),
	Z1_QTD				FLOAT,
	Z1_UND				VARCHAR(2),
	Z1_COD_CLI			VARCHAR(6),
	Z1_NOME_CLI			VARCHAR(70),
	Z1_NOME_CLI_REDU	VARCHAR(20),
	Z1_CIDADE_UF		VARCHAR(63),
	Z1_COD_VEND			VARCHAR(6),
	Z1_VENDEDOR			VARCHAR(40),
	Z1_COD_FOR			VARCHAR(6),
	Z1_FORNECEDOR		VARCHAR(40),
	Z1_NOME_FOR_REDU	VARCHAR(20),
	Z1_PRZ_FOR_DIAS		FLOAT,
	Z1_VLR_TOTAL_ATM	FLOAT,
	Z1_DATA_FAT			VARCHAR(30),
	Z1_DOC700			VARCHAR(9),
	Z1_SER700			VARCHAR(3),
	Z1_NUM_RES_MANU		VARCHAR(6),
	Z1_FILIAL_PAI		VARCHAR(4),
	Z1_NUM_ORC_PAI		VARCHAR(6),
	Z1_SERIE_PAI		VARCHAR(3),
	Z1_NOTA_PAI			VARCHAR(9),
	Z1_FILIAL_FILHO		VARCHAR(4),
	Z1_NUM_ORC_FILHO 	VARCHAR(6),
	Z1_SERIE_FILHO		VARCHAR(3),
	Z1_NOTA_FILHO		VARCHAR(9),
	Z1_ORCRES_DO_FILHO	VARCHAR(6),
	Z1_FILIAL_SC		VARCHAR(4),
	Z1_NUM_SC			VARCHAR(6),
	Z1_FILIAL_PC		VARCHAR(4),		
	Z1_NUM_PC			VARCHAR(6),
	Z1_FILIAL_PV		VARCHAR(4),
	Z1_NUM_PV			VARCHAR(6),
	Z1_DT_DOCSAI		VARCHAR(30),
	Z1_SERIE_C6			VARCHAR(3),
	Z1_NOTA_C6			VARCHAR(9),
	Z1_FILIAL_C6_TROCA	VARCHAR(4),
	Z1_NUM_C6_TROCA		VARCHAR(6),	
	Z1_DT_DOCSAI_TROCA	VARCHAR(30),
	Z1_SERIE_C6_TROCA  	VARCHAR(3),
	Z1_NOTA_C6_TROCA	VARCHAR(9),
	Z1_DT_NOTA_ENTRADA	VARCHAR(30),
	Z1_SERIE_ENTRADA	VARCHAR(3),
	Z1_NOTA_ENTRADA    	VARCHAR(9),
	Z1_PRZ_ENT_FOR		VARCHAR(30),
	Z1_DT_HJ			VARCHAR(30),
	Z1_DT_ENT_CLI      	VARCHAR(30),
	--ESTAGIO				VARCHAR(300),
