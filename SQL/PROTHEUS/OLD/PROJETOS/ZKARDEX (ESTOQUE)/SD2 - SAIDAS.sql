...
LEFT JOIN SF2010 SF2 ON SF2.D_E_L_E_T_ = '' AND SF2.F2_FILIAL = SD2.D2_FILIAL AND SF2.F2_SERIE = SD2.D2_SERIE AND SF2.F2_DOC = SD2.D2_DOC AND SF2.F2_CLIENTE = SD2.D2_CLIENTE AND SF2.F2_LOJA = SD2.D2_LOJA AND SFT.FT_DTCANC <> ''
...
--AND SFT.FT_DTCANC <> ''
AND SD2.D2_FILIAL = '0103'
AND SD2.D2_DOC = '000000554' 
GROUP BY
SD2.D2_FILIAL,
SD2.D2_SERIE,
SD2.D2_DOC,
