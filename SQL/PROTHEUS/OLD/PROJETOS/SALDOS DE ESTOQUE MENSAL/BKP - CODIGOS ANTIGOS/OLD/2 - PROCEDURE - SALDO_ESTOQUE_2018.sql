...
INSERT INTO #AUX (AUX_DATSLD, AUX_CODPROD, AUX_PRODUTO, AUX_UND, AUX_CUSTPROD, AUX_CODFOR ,	AUX_LOJFOR, AUX_GRUPPROD, AUX_CODLIN, AUX_CODFAM, AUX_CUSTPROD_ATT, AUX_SALDO, AUX_CUSTO, AUX_CUSTO_ATT) 



SELECT @DTSLD AS DT_SLD, *,
...
SELECT 	A.B1_COD   	  AS COD_PROD,
		...
		SELECT TAB1.B1_CUSTD FROM SB1010 TAB1 WHERE TAB1.D_E_L_E_T_ = '' AND TAB1.B1_COD = A.B1_COD
		)) AS CUSTO_ATT		
FROM SB1010 A 
