CREATE
PROCEDURE UPDATE_SALDO_ESTOQUE_2018 AS
...
--SELECT @DTSLD, @cDatIni, @cDatFim

/*--------------------------------------------------------------*/

SET @SQL =
INSERT INTO #AUX (AUX_DATSLD, AUX_CODPROD, AUX_PRODUTO, AUX_UND, AUX_CUSTPROD, AUX_CODFOR ,	AUX_LOJFOR, AUX_GRUPPROD, AUX_CODLIN, AUX_CODFAM, AUX_SALDO, AUX_CUSTO) 
