...
Static Function fAtualizaTit()
    ...
    /* ----------------------------------- PJ Somente Campinas e Ribeirao ----------------------------------- */
    ...
    Begin Transaction
        ...
        cQryRSE1PJ += " AND ISNULL(( SELECT TOP 1 SE1.E1_CLIENTE FROM SE1010 SE1 WHERE 1=1 AND SE1.D_E_L_E_T_ = '' AND SE1.E1_ZSTSLD = '6' AND SE1.E1_SALDO >  0 AND SE1.E1_CLIENTE = SE1010.E1_CLIENTE AND SE1.E1_LOJA = SE1010.E1_LOJA ),'') <> '' "
    ...
    Begin Transaction
        ...
        cQryRSE1PF += " AND ISNULL(( SELECT TOP 1 SE1.E1_CLIENTE FROM SE1010 SE1 WHERE 1=1 AND SE1.D_E_L_E_T_ = '' AND SE1.E1_ZSTSLD = '6' AND SE1.E1_SALDO >  0 AND SE1.E1_CLIENTE = SE1010.E1_CLIENTE AND SE1.E1_LOJA = SE1010.E1_LOJA ),'') <> '' "
    ...
    Begin Transaction
        ...
        cQryRSK1PJ += " AND ISNULL(( SELECT TOP 1 SE1.E1_CLIENTE FROM SE1010 SE1 WHERE 1=1 AND SE1.D_E_L_E_T_ = '' AND SE1.E1_ZSTSLD = '6' AND SE1.E1_SALDO >  0 AND SE1.E1_CLIENTE = SK1010.K1_CLIENTE AND SE1.E1_LOJA = SK1010.K1_LOJA ),'') <> '' "
    ...
    Begin Transaction
        ...
        cQryRSK1PF += " AND ISNULL(( SELECT TOP 1 SE1.E1_CLIENTE FROM SE1010 SE1 WHERE 1=1 AND SE1.D_E_L_E_T_ = '' AND SE1.E1_ZSTSLD = '6' AND SE1.E1_SALDO >  0 AND SE1.E1_CLIENTE = SK1010.K1_CLIENTE AND SE1.E1_LOJA = SK1010.K1_LOJA ),'') <> '' "
