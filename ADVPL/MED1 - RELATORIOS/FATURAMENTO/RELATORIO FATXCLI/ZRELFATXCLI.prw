...
Static Function fMontaExcel(cPasta)
	...
	oExcel:AddColumn("CADCLI","LISTCLI", "TIPOCTR",		1,1,.F.,"")
		...
		cQueryCLI += " AND CASE "
		cQueryCLI += " 	WHEN A.BQC_DATBLO <> '' THEN A.BQC_DATBLO "
		cQueryCLI += " 	WHEN ISNULL(( SELECT MAX(CASE WHEN SUBSTRING(BQCDT.BQC_USERGA, 03, 1) != ' ' AND BQCDT.BQC_USERGA != '' THEN CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(BQCDT.BQC_USERGA,12,1)) - 50, ASCII(SUBSTRING(BQCDT.BQC_USERGA,16,1)) - 50) + IIF(SUBSTRING(BQCDT.BQC_USERGA,08,1) = '<',10000,0)),'19000101'), 103) ELSE '19000101' END) FROM BQC010 BQCDT WHERE 1=1 AND BQCDT.D_E_L_E_T_ = '' AND BQCDT.BQC_CODINT = A.BQC_CODINT AND BQCDT.BQC_CODEMP = A.BQC_CODEMP AND BQCDT.BQC_NUMCON = A.BQC_NUMCON AND BQCDT.BQC_VERCON = A.BQC_VERCON AND BQCDT.BQC_SUBCON = A.BQC_SUBCON AND BQCDT.BQC_VERSUB = A.BQC_VERSUB ),'') <> '' THEN ISNULL(( SELECT MAX(CASE WHEN SUBSTRING(BQCDT.BQC_USERGA, 03, 1) != ' ' AND BQCDT.BQC_USERGA != '' THEN CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(BQCDT.BQC_USERGA,12,1)) - 50, ASCII(SUBSTRING(BQCDT.BQC_USERGA,16,1)) - 50) + IIF(SUBSTRING(BQCDT.BQC_USERGA,08,1) = '<',10000,0)),'19000101'), 103) ELSE '19000101' END) FROM BQC010 BQCDT WHERE 1=1 AND BQCDT.D_E_L_E_T_ = '' AND BQCDT.BQC_CODINT = A.BQC_CODINT AND BQCDT.BQC_CODEMP = A.BQC_CODEMP AND BQCDT.BQC_NUMCON = A.BQC_NUMCON AND BQCDT.BQC_VERCON = A.BQC_VERCON AND BQCDT.BQC_SUBCON = A.BQC_SUBCON AND BQCDT.BQC_VERSUB = A.BQC_VERSUB ),'') "
		cQueryCLI += " 	WHEN ISNULL(( SELECT MAX(CASE WHEN SUBSTRING(BQCDT.BQC_USERGI, 03, 1) != ' ' AND BQCDT.BQC_USERGI != '' THEN CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(BQCDT.BQC_USERGI,12,1)) - 50, ASCII(SUBSTRING(BQCDT.BQC_USERGI,16,1)) - 50) + IIF(SUBSTRING(BQCDT.BQC_USERGI,08,1) = '<',10000,0)),'19000101'), 103) ELSE '19000101' END) FROM BQC010 BQCDT WHERE 1=1 AND BQCDT.D_E_L_E_T_ = '' AND BQCDT.BQC_CODINT = A.BQC_CODINT AND BQCDT.BQC_CODEMP = A.BQC_CODEMP AND BQCDT.BQC_NUMCON = A.BQC_NUMCON AND BQCDT.BQC_VERCON = A.BQC_VERCON AND BQCDT.BQC_SUBCON = A.BQC_SUBCON AND BQCDT.BQC_VERSUB = A.BQC_VERSUB ),'') <> '' THEN ISNULL(( SELECT MAX(CASE WHEN SUBSTRING(BQCDT.BQC_USERGI, 03, 1) != ' ' AND BQCDT.BQC_USERGI != '' THEN CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(BQCDT.BQC_USERGI,12,1)) - 50, ASCII(SUBSTRING(BQCDT.BQC_USERGI,16,1)) - 50) + IIF(SUBSTRING(BQCDT.BQC_USERGI,08,1) = '<',10000,0)),'19000101'), 103) ELSE '19000101' END) FROM BQC010 BQCDT WHERE 1=1 AND BQCDT.D_E_L_E_T_ = '' AND BQCDT.BQC_CODINT = A.BQC_CODINT AND BQCDT.BQC_CODEMP = A.BQC_CODEMP AND BQCDT.BQC_NUMCON = A.BQC_NUMCON AND BQCDT.BQC_VERCON = A.BQC_VERCON AND BQCDT.BQC_SUBCON = A.BQC_SUBCON AND BQCDT.BQC_VERSUB = A.BQC_VERSUB ),'') "
		cQueryCLI += " 	ELSE '' "
		cQueryCLI += " END  BETWEEN '"+Dtos(MV_PAR01)+"' AND '"+Dtos(MV_PAR02)+"' "
		...
		cQueryCLI += " AND CASE  "
		cQueryCLI += "	WHEN B.BA3_DATBLO <> '' THEN B.BA3_DATBLO "
		cQueryCLI += " 	WHEN SUBSTRING(B.BA3_USERGA, 03, 1) != ' ' AND B.BA3_USERGA != '' THEN CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(B.BA3_USERGA,12,1)) - 50, ASCII(SUBSTRING(B.BA3_USERGA,16,1)) - 50) + IIF(SUBSTRING(B.BA3_USERGA,08,1) = '<',10000,0)),'1996-01-01'), 112)  "
		cQueryCLI += " 	WHEN SUBSTRING(B.BA3_USERGI, 03, 1) != ' ' AND B.BA3_USERGI != '' THEN CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(B.BA3_USERGI,12,1)) - 50, ASCII(SUBSTRING(B.BA3_USERGI,16,1)) - 50) + IIF(SUBSTRING(B.BA3_USERGI,08,1) = '<',10000,0)),'1996-01-01'), 112)  "
		cQueryCLI += " 	ELSE ''  "
		cQueryCLI += " END BETWEEN '"+Dtos(MV_PAR01)+"' AND '"+Dtos(MV_PAR02)+"' "
