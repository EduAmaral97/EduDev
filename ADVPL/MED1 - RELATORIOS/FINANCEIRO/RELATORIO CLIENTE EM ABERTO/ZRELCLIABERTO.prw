...
Static Function fMontaRel(cPasta)
	...
	oExcel:AddColumn("ZRELCLIABERTO","CLIABERT","VLRTIT"		,1,3,.F., "@E 999999999.99")
	oExcel:AddColumn("ZRELCLIABERTO","CLIABERT","SALDO"			,1,3,.F., "@E 999999999.99")
