...
Static Function fInclusao()
	...
	cQuery += " AND BF4.BF4_CODPRO IN ('0036','0040','0071','0066') "
	cQuery += " GROUP BY BA1.BA1_NOMUSR	,BA1.BA1_CPFUSR, SA1.A1_CGC, SA1.A1_NOME, BA1.BA1_FILIAL, BT5.BT5_NOME, BQC.BQC_ESPTEL "
	...
	While (_cAlias)->(!Eof())
		...
		oExcel:AddRow("TELEMEDINC","TELEMED",{(_cAlias)->NOME,(_cAlias)->CPF,(_cAlias)->CNPJ,(_cAlias)->EMPRESACLI,(_cAlias)->EMPRESA,(_cAlias)->TIPOCONTRATO,(_cAlias)->TELEESP})
