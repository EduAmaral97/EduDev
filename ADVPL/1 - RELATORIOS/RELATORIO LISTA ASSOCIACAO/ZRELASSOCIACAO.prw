...
//********************************************************************************************//
User Function ZRELASSOCIACAO(cListaContratoAssociacao)
		

	DEFAULT cListaContratoAssociacao  := ""
	Private cAgencia	    := ""
	Private cConta		  	:= ""
	...
	If !Empty(cListaContratoAssociacao)
		Pergunte(cPerg,.F.)
		//MV_PAR04 := cListaContratoAssociacao
...
Static Function Imprime()
	...
	While (_cAlias)->(!Eof())
		...
		If cCodUndOrg <> (_cAlias)->CODORG
			...
			cCodUndOrg :=(_cAlias)->CODORG
			
			nLin += 40
			
			oPrn:say(nLin,0115,SubStr( (_cAlias)->CGCORG,1,2 ) + '.' + SubStr( (_cAlias)->CGCORG,3,3 ) + '.' + SubStr( (_cAlias)->CGCORG,6,3 ) + '/' + SubStr( (_cAlias)->CGCORG,9,4 ) + '-' + SubStr( (_cAlias)->CGCORG,12,2),oFont10N)
			oPrn:say(nLin,0550,(_cAlias)->UNDORG,oFont10N)	
...
Static Function  Cabec(_lCabec)
	...
	oPrn:say(0150,0550, "Listagem Associacao",oFont13N)
...
Static Function MontaQuery
	...
	cQuery += "BBZ.BBZ_CODORG	AS CODORG, "
	cQuery += "BBZ.BBZ_DESCRI	AS UNDORG, "
	cQuery += "BBZ.BBZ_CGC		AS CGCORG "
	...
	cQuery += "LEFT JOIN BA3010 BA3 ON BA3.BA3_FILIAL = BA1.BA1_FILIAL	AND BA3.BA3_CODINT = BA1.BA1_CODINT	AND BA3.BA3_CODEMP = BA1.BA1_CODEMP	AND BA3.BA3_MATRIC = BA1.BA1_MATRIC	AND BA3.BA3_CONEMP = BA1.BA1_CONEMP	AND BA3.BA3_VERCON = BA1.BA1_VERCON	AND BA3.BA3_SUBCON = BA1.BA1_SUBCON	AND BA3.BA3_VERSUB = BA1.BA1_VERSUB	AND BA3.D_E_L_E_T_ = '' "
	cQuery += "LEFT JOIN BBZ010 BBZ ON BBZ.BBZ_CODORG = BA3.BA3_UNDORG "
	cQuery += "WHERE 1=1  "
