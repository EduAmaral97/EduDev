...
Static Function fMontaExcel(cPasta)
	...
	oExcel:AddColumn("TITABERTO","TITULOS", "DESCCLVL", 	,1,1,.F., "")
		...
		cQuery += " (SE1.E1_VALOR - "
		cQuery += " ISNULL(( "
		cQuery += " 	SELECT SUM(A.E1_VALOR)  "
		cQuery += " 	FROM SE1010 A  "
		cQuery += " 	WHERE 1=1 "
		cQuery += " 	AND A.D_E_L_E_T_ = ''  "
		cQuery += " 	AND A.E1_TIPO IN ('CF-','PI-','CS-','IN-','IS-','IR-')  "
		cQuery += " 	AND A.E1_FILIAL = SE1.E1_FILIAL  "
		cQuery += " 	AND A.E1_PREFIXO = SE1.E1_PREFIXO  "
		cQuery += " 	AND A.E1_NUM = SE1.E1_NUM  "
		cQuery += " 	AND A.E1_CLIENTE = SE1.E1_CLIENTE  "
		cQuery += " 	AND A.E1_LOJA = SE1.E1_LOJA "
		cQuery += " 	),0)"
		cQuery += "	)					AS VALORLIQ, "		
		cQuery += " (SE1.E1_VALOR - "
		cQuery += " ISNULL(( "
		...
		cQuery += " AND SE1.E1_TIPO NOT IN ('RA','CF-','PI-','CS-','IN-','IS-','IR-') "
