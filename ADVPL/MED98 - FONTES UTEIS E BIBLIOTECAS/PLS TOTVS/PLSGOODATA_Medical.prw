...
@version 1.0
/*/
User Function PLSFAMed(lAutoma,cDBAuto,lExQryAuto)
   LOCAL nLoop := 0
...
static function Fast_D_BA1()
   ...
   cSql +=  " SELECT "
   cSql +=  " BA1_CODINT" + cConc + "BA1_CODEMP" + cConc + "BA1_MATRIC" + cConc + "BA1_TIPREG " + cConc + " BA1_DIGITO "+ cConc +"'-'"+ cConc + " BA1_FILIAL Matricula_Completa_Ben, "
   cSql +=  " BA1_CODINT" + cConc + "BA1_CODEMP" + cConc + "BA1_MATRIC " + cConc +"'-'"+ cConc + " BA1_FILIAL Matricula_Familia, "
   ...
   cSql +=  " WHERE " + RETSQLName("BA1") + ".D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_BG3()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Bloqueio_Beneficiario_BG3_V3 AS "
   cSql +=  " SELECT BG3_PROPRI" + cConc + "BG3_CODBLO " + cConc +"'-'"+ cConc +  " BG3_FILIAL Codigo_Bloqueio_Ben, "
   cSql +=  " BG3_DESBLO Desc_Bloqueio_Ben FROM " + RETSQLName("BG3") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
static function Fast_D_BQU()
   ...
   cSql +=  " FROM " + RETSQLName("BQU") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
static function Fast_D_BC9()
   ...
   cSql +=  " BC9_EST Estado FROM " + RETSQLName("BC9") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
static function Fast_D_SA1()
   ...
   cSql +=  " A1_CEP CEP_Cliente, A1_CGC CGC_Cliente FROM " + RETSQLName("SA1") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
static function Fast_D_BT5()
   ...
   cSql += "FROM " + RETSQLName("BT5") + cNoLock + " WHERE D_E_L_E_T_ = ' ' UNION ALL SELECT BG9_CODINT" + cConc + "BG9_CODIGO" + cConc + "'-1',  BG9_CODINT, BG9_CODIGO, '-1', '19500101'  FROM " + RETSQLName("BG9") + cNoLock + " WHERE BG9_TIPO = '1'  AND D_E_L_E_T_ = ' ' "
...
static function Fast_D_BXL()
   ...
   cSql +=  " SELECT BXL_CODEQU Codigo_Equipe_Venda, BXL_DESEQU Nome_Equipe_Venda FROM " + RETSQLName("BXL") + cNoLock + " WHERE " + RETSQLName("BXL") +".D_E_L_E_T_ = ' ' "
...
static function Fast_F_Des()
   ...
   cSql += " AND E2_PREFIXO    = BD6_PREFIX "
   cSql += " AND E2_NUMTIT    = BD6_NUMTIT "
   cSql += " AND E2_PARCELA    = BD6_PARCEL "
   cSql += " AND E2_TIPO    = BD6_TIPTIT "
...
static function Fast_F_Ben()
   ...
   cSql += " END "
   cSql += " END "
   cSql += " AS Data_Inclusao_Ben, BA1_CODINT Cod_Operadora, BA1_CODINT " + cConc + " BA1_CODEMP " + cConc +"'-'"+ cConc +  " BA1_FILIAL Cod_Operadora_Grupo_Emp, "
   ...
   cSql += " BA1_CODINT " + cConc + " BA1_CODEMP " + cConc + " BA1_MATRIC " + cConc + " BA1_TIPREG " + cConc + " BA1_DIGITO "
   cSql += cConc + "'-'" + cConc +" BA1_FILIAL Matricula_Completa_Ben, "
   cSql += " BA1_TIPUSU Tipo_de_Ben, "
   ...
   if(cDBType == "SQL")
      cSql += " ( BFM_ANO = datepart(year,getdate())-1 ) OR ( BFM_ANO = datepart(year,getdate()) AND BFM_MES <= datepart(MONTH,getdate()) ) "
   Else
      cSql += " ( (BFM_ANO = to_char(SYSDATE - 365,'YYYY') ) OR ( BFM_ANO = to_char(SYSDATE,'YYYY')) AND BFM_MES <= to_char(sysdate,'MM') ) "
   Endif
   ...
   cSql += " ON BQC_CODIGO = BA1_CODINT " + cConc + " BA1_CODEMP "
...
@version 1.0
/*/
static function Fast_F_Rec()

   local cSql := ""
   local nStatus := 0

   cSql +=  " SELECT "
   cSql +=  " BM1_CODINT" + cConc + "BM1_CODEMP" + cConc + "BM1_MATRIC" + cConc + "BM1_TIPREG" + cConc + "BA1_DIGITO"
   cSql +=  cConc +"'-'"+ cConc +  " BM1_FILIAL Matricula_Completa_Ben, "
   cSql +=  " BM1_CODINT Codigo_Operadora, "
   cSql +=  " BM1_CODINT " + cConc + " BM1_CODEMP Cod_Operadora_Emp, "
   cSql +=  " BM1_MATRIC" + cConc +"'-'"+ cConc +" BM1_FILIAL Matricula_da_Familia, "
   ...
   cSql += " BA3_CODINT " + cConc + " BA3_CODPLA "
   cSql += " END "
   cSql +=  " AS Codigo_Operadora_Produto, BM1_CODINT " + cConc + " BM1_CODEMP " + cConc + " BM1_CONEMP Cod_Operadora_Emp_Num_Con, "
   cSql +=  " BM1_CODINT " + cConc + " BM1_CODEMP " + cConc + " BM1_CONEMP " + cConc + " BM1_SUBCON Cod_Oper_Grupo_Emp_Num_Subcon, "
   ...
   cSql += " AND BA1_FILIAL = BA3_FILIAL "
   cSql += " AND BA1_CODINT = BA3_CODINT "
   cSql += " AND BA1_CODEMP = BA3_CODEMP "
   cSql += " AND BA1_MATRIC = BA3_MATRIC "
   cSql += " AND " + RETSQLName("BA1") + ".D_E_L_E_T_ = ' ' "
   cSql += " AND BA3_FILIAL = BM1_FILIAL "
   cSql += " AND " + RETSQLName("BA3") + ".D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_BRP()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Grau_Parentesco_BRP_V3 AS "
   cSql +=  " SELECT BRP_CODIGO Codigo_Tipo_Grau_Parentesco, BRP_DESCRI Desc_Grau_Parentesco FROM " + RETSQLName("BRP") + cNoLock
   cSql +=  " WHERE D_E_L_E_T_ = ' ' "
...
static function Fast_D_BG9()
   ...
   cSql +=  RETSQLName("BG9") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
static function Fast_D_BI3()
   ...
   cSql +=  " FROM " + RETSQLName("BI3") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_BID()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Municipio_BID_V3 AS "
   cSql +=  " SELECT BID_CODMUN "+ cConc +"'-'"+ cConc +" BID_FILIAL Codigo_Municipio, BID_DESCRI Nome_do_Municipio, BID_EST Estado_Municipio, CASE WHEN BID_EST = 'AC' THEN '12' WHEN BID_EST = 'AL' THEN '27' "
   ...
   cSql +=  " ELSE 'XX' END as Estado FROM " + RETSQLName("BID") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_BA0()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Operadora_BA0_V3 AS "
   cSql +=  " SELECT BA0_CODIDE" + cConc + "BA0_CODINT " + cConc +"'-'"+ cConc + " BA0_FILIAL CODOPE, "
   cSql +=  " BA0_NOMINT, BA0_CODMUN CODMUN FROM  " + RETSQLName("BA0") + cNoLock + " WHERE D_E_L_E_T_ = ' ' AND "
   cSql +=  " EXISTS (SELECT BA1_FILIAL FROM " + RETSQLName("BA1") + cNoLock + " WHERE BA1_FILIAL = BA0_FILIAL AND BA1_OPEORI = BA0_CODIDE" + cConc + "BA0_CODINT AND BA1_MOTBLO = '"+Space(03)+"' AND D_E_L_E_T_ = ' ') "
...
@version 1.0
/*/
static function Fast_D_BIH()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Tipo_Beneficiario_BIH_V3 AS "
   cSql +=  " SELECT BIH_CODTIP Cod_Tipo_Ben, BIH_DESCRI Desc_Tipo_Ben FROM " + RETSQLName("BIH") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_BII()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Tipo_Contrato_BII_V3 AS "
   cSql +=  " SELECT RTRIM(LTRIM(BII_CODIGO)) Cod_Tipo_de_Con, BII_DESCRI Desc_Tipo_de_Con FROM " + RETSQLName("BII") + cNoLock + " WHERE D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_SA3()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Vendedores_SA3_V3 "
   cSql +=  " AS SELECT LTRIM(RTRIM(A3_COD)) Cod_Vendedor, A3_NOME Nome_Vendedor FROM " + RETSQLName("SA3") + cNoLock
   cSql +=  " WHERE " + RETSQLName("SA3") + ".D_E_L_E_T_ = ' ' "
...
@version 1.0
/*/
static function Fast_D_BJ1()

   local cSql := ""
   local nStatus := 0

   cSql +=  " CREATE VIEW Formas_de_Cobranca_BJ1_V3 "
   cSql +=  " AS SELECT BJ1_CODIGO "+ cConc +"'-'"+ cConc +"BJ1_FILIAL AS BJ1_CODIGO , BJ1_DESCRI "
   cSql +=  "FROM "+RETSQLName("BJ1") + cNoLock + " WHERE " + RETSQLName("BJ1") + ".D_E_L_E_T_ = ' ' "
