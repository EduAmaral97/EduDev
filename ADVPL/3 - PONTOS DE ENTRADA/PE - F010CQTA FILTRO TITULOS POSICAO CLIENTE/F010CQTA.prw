...
User Function F010CQTA()
    ...
    IF MsgYesNo("Deseja remover titulos 'RA' da listagem? ")
        ...
        cQuery := " SELECT E1_LOJA,E1_FILORIG,E1_PREFIXO,E1_NUM,E1_PARCELA,E1_TIPO,E1_NFELETR,E1_CLIENTE,E1_EMISSAO,E1_VENCTO,E1_VENCREA, "
        cQuery += " E1_BAIXA,E1_VALOR,E1_VLCRUZ,E1_SDACRES,E1_SDDECRE,E1_VALJUR,E1_SALDO,E1_NATUREZ,E1_PORTADO,E1_NUMBCO,E1_NUMLIQ,E1_HIST, "
        cQuery += " E1_CHQDEV,E1_SITUACA,E1_PORCJUR,E1_MOEDA,E1_VALOR,E1_TXMOEDA,SE1.R_E_C_N_O_ SE1RECNO,FRV.FRV_DESCRI ,SE1.E1_FILIAL "
