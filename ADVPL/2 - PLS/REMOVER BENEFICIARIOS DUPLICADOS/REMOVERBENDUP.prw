...
/*
	...
	AND A.D_E_L_E_T_ = '' 	
	AND A.BA1_SUBCON = '000000001'
	AND A.BA1_CODEMP IN ('0003','0006')
    AND A.BA1_DATBLO = ''
	GROUP BY A.BA1_FILIAL,	A.BA1_CODINT,	A.BA1_CODEMP,	A.BA1_CONEMP,	A.BA1_SUBCON,	A.BA1_MATVID,	A.BA1_NOMUSR, A.BA1_DATBLO
    HAVING COUNT (*) > 1 
