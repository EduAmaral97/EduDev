...
Static Function ZINC()
    ...
    DEFINE DIALOG oDlg TITLE "Despesas Frota Medicar - Incluir " FROM aCoors[1], aCoors[1] TO aCoors[3], aCoors[4] PIXEL
        ...
        oBrowse := TCBrowse():New( aCoors[1]+150, aCoors[1], (aCoors[4] - (aCoors[4]/2)), aCoors[3]/3,, {'','Filial','Serie','Documento','Placa','Valor Unitario','Quantidade','Valor','Centro Custo','Classe Valor','Insumo','Condutor','Posto'},{20,50,50,50,50,50,50,50,50,50,50,50}, oDlg,,,,,{||},,,,,,,.F.,,.T.,,.F.,,, ) //CABECARIO DA GRADE
        ...
        TButton():New(aCoors[1]+65,(aCoors[3]/1.03) , "Gerar Pedido"        , oDlg, {|| fBtnPed(cFunc)}, 50,018, ,,,.T.,,,,,,)
...
Static Function ZALT()
    ...
    DEFINE DIALOG oDlg TITLE "Despesas Frota Medicar - Alterar " FROM aCoors[1], aCoors[1] TO aCoors[3], aCoors[4] PIXEL
        ...
        TButton():New(aCoors[1]+15,(aCoors[3]/1.03) , "Salvar"              , oDlg, {|| fBtnSalvar(cFunc,cFilialFtr,cSerie,cDoc,cFornecedor,cLoja,cProduto,cTipoDesp,cCondpg)}, 50,018, ,,,.T.,,,,,,)
        TButton():New(aCoors[1]+40,(aCoors[3]/1.03) , "Importar Placas"     , oDlg, {|| fBtnImpArq(cFunc)}, 50,018, ,,,.T.,,,,,,)
        TButton():New(aCoors[1]+65,(aCoors[3]/1.03) , "Gerar Pedido"        , oDlg, {|| fBtnPed(cFunc,cFilialFtr,cSerie,cDoc,cFornecedor,cLoja,cTotalPlaca,cTotalQtd,cTotalValor,cProduto,cCondpg)}, 50,018, ,,,.T.,,,,,,)
