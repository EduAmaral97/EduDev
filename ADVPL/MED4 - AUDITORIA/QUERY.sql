...
A.E1_CLIENTE,
A.E1_EMISSAO,
SUBSTRING(A.E1_USERLGI, 11,1)+
SUBSTRING(A.E1_USERLGI, 15,1)+
SUBSTRING(A.E1_USERLGI, 2, 1)+
SUBSTRING(A.E1_USERLGI, 6, 1)+
SUBSTRING(A.E1_USERLGI, 10,1)+
SUBSTRING(A.E1_USERLGI, 14,1)+
SUBSTRING(A.E1_USERLGI, 1, 1)+
SUBSTRING(A.E1_USERLGI, 5, 1)+
SUBSTRING(A.E1_USERLGI, 9, 1)+
SUBSTRING(A.E1_USERLGI, 13,1)+
SUBSTRING(A.E1_USERLGI, 17,1)+
SUBSTRING(A.E1_USERLGI, 4, 1) AS COD_Usuario_CRIACAO,
UCRI.USR_CODIGO AS USUARIO_CRI,
 CASE WHEN SUBSTRING(E1_USERLGI, 03, 1) != ' ' AND E1_USERLGI != '' THEN
        CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(E1_USERLGI,12,1)) - 50, ASCII(SUBSTRING(E1_USERLGI,16,1)) - 50) + IIF(SUBSTRING(E1_USERLGI,08,1) = '<',10000,0)),'1996-01-01'), 103)
    ELSE ''
    END AS DATA_INCL,
SUBSTRING(A.E1_USERLGA, 11,1)+
SUBSTRING(A.E1_USERLGA, 15,1)+
SUBSTRING(A.E1_USERLGA, 2, 1)+
SUBSTRING(A.E1_USERLGA, 6, 1)+
SUBSTRING(A.E1_USERLGA, 10,1)+
SUBSTRING(A.E1_USERLGA, 14,1)+
SUBSTRING(A.E1_USERLGA, 1, 1)+
SUBSTRING(A.E1_USERLGA, 5, 1)+
SUBSTRING(A.E1_USERLGA, 9, 1)+
SUBSTRING(A.E1_USERLGA, 13,1)+
SUBSTRING(A.E1_USERLGA, 17,1)+
SUBSTRING(A.E1_USERLGA, 4, 1) COD_Usuario_ALTERACAO,
UALT.USR_CODIGO AS USUARIO_ALT,
   CASE WHEN SUBSTRING(E1_USERLGA, 03, 1) != ' ' AND E1_USERLGA != '' THEN
        CONVERT(VARCHAR,DATEADD(DAY,CONVERT(INT,CONCAT(ASCII(SUBSTRING(E1_USERLGA,12,1)) - 50, ASCII(SUBSTRING(E1_USERLGA,16,1)) - 50) + IIF(SUBSTRING(E1_USERLGA,08,1) = '<',10000,0)),'1996-01-01'), 103)
    ELSE ''
    END AS DATA_ALT
FROM SE1010 A
LEFT JOIN SYS_USR UCRI ON UCRI.D_E_L_E_T_ = '' AND UCRI.USR_ID = SUBSTRING(A.E1_USERLGI, 11,1)+SUBSTRING(A.E1_USERLGI, 15,1)+SUBSTRING(A.E1_USERLGI, 2, 1)+SUBSTRING(A.E1_USERLGI, 6, 1)+SUBSTRING(A.E1_USERLGI, 10,1)+SUBSTRING(A.E1_USERLGI, 14,1)+SUBSTRING(A.E1_USERLGI, 1, 1)+SUBSTRING(A.E1_USERLGI, 5, 1)+SUBSTRING(A.E1_USERLGI, 9, 1)+SUBSTRING(A.E1_USERLGI, 13,1)+SUBSTRING(A.E1_USERLGI, 17,1)+SUBSTRING(A.E1_USERLGI, 4, 1)
LEFT JOIN SYS_USR UALT ON UALT.D_E_L_E_T_ = '' AND UALT.USR_ID = SUBSTRING(A.E1_USERLGA, 11,1)+SUBSTRING(A.E1_USERLGA, 15,1)+SUBSTRING(A.E1_USERLGA, 2, 1)+SUBSTRING(A.E1_USERLGA, 6, 1)+SUBSTRING(A.E1_USERLGA, 10,1)+SUBSTRING(A.E1_USERLGA, 14,1)+SUBSTRING(A.E1_USERLGA, 1, 1)+SUBSTRING(A.E1_USERLGA, 5, 1)+SUBSTRING(A.E1_USERLGA, 9, 1)+SUBSTRING(A.E1_USERLGA, 13,1)+SUBSTRING(A.E1_USERLGA, 17,1)+SUBSTRING(A.E1_USERLGA, 4, 1) 
WHERE 1=1
AND A.D_E_L_E_T_ = ''
AND A.E1_FILIAL = '003001'
AND A.E1_NUM = '000000037' 
AND A.E1_PREFIXO = 'FAT'
AND A.E1_CLIENTE = '048535'
