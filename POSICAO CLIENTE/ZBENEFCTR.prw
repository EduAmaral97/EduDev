...
User Function ZBENEFCTR(cSA1cliente, cSA1lojacli, cIdcontrato, cIdent)
   
    Local aArea := GetArea()
    
    fMontaBeneficiario(cSA1cliente, cSA1lojacli, cIdcontrato, cIdent)
    
    RestArea(aArea)

Return
 
Static Function fMontaBeneficiario(cSA1cliente, cSA1lojacli, cIdcontrato, cIdent)
    ...
    Processa({|| fPopulaBen(cSA1cliente, cSA1lojacli, cIdcontrato, cIdent)}, "Processando...")
...
Static Function fPopulaBen(cSA1cliente, cSA1lojacli, cIdcontrato, cIdent)
